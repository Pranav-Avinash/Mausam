  ...
  const updateSky = (data) => {
    ...
    if (now >= sunrise && now < sunset) {
      if (now < sunrise + 7200) { 
        ...
        app.style.backgroundColor = '#4682B4';
      } 
      else {
        app.style.backgroundColor = '#1E90FF';
      }

      setSkyState({ showStars: false });

    } else {
      app.style.backgroundColor = '#101010';

      setSkyState({ showStars: true });
    }
  };
